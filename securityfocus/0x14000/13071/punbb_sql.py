...
def usage():
   ...
   print "        -e email      email address where the admin leve
   activation email is sent"
   print "        -d domain     catch all domain to catch
   \"some-SQL-Query\"@domain emails"
   print ""
   sys.exit(-1)
...
def main():
   ...
   print "[+] Done... Now wait for the email. Log into punBB, go to the link
   in the email and become admin"
