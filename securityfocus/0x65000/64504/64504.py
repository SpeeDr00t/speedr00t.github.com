#!/usr/bin/python
#Title: Easy Karaokay <span id="a2011t6lrv75_3" class="a2011t6lrv75">Player</span> 3.3.31 (.wav) <span id="a2011t6lrv75_2" class="a2011t6lrv75">Integer</span> Division by Zero
#Version: 3.3.31 (<span id="a2011t6lrv75_1" class="a2011t6lrv75">Older Versions</span> might be vulnerable as well)
